...
def parse_args():
    ...
    Returns: 
        argparse.Namespace: parsed arguments. コマンドラインから指定したオプションでディレクトリとか決定する
        py -m pascalvoc_metrics.py --gt_dir detections --gt_format xyrb --det_dir detections --det_format xyrb --output output

    """
    # fmt: off
    parser = argparse.ArgumentParser()
    parser.add_argument("--gt_dir", type=Path,  default="groundtruths",
    ...
    parser.add_argument("--det_dir", type=Path,  default="detections",
